...
//npx hardhat getPriceFeed --address 0xkdfdfkfk --price "100"  --image "http:fdhfkdfk"
task("getPriceFeed", "Uploads an NFT to the Contract").setAction(async (taskArgs) => {
    ...
    const data = await myNFTOffchainGeneratorContract.getPriceFeed()
    console.log("Price Feed Address: ", data)
})
