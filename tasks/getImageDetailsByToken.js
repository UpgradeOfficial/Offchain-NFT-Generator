...
//npx hardhat getImageDetailsByToken --address 0xkdfdfkfk --price "100"  --image "http:fdhfkdfk"
task("getImageDetailsByToken", "Uploads an NFT to the Contract")
    ...
    .setAction(async (taskArgs) => {
        ...
        const data = await myNFTOffchainGeneratorContract.getImageDetailsByToken(id)
