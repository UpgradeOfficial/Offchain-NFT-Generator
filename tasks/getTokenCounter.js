...
//npx hardhat getTokenCounter --address 0xkdfdfkfk --price "100"  --image "http:fdhfkdfk"
task("getTokenCounter", "Uploads an NFT to the Contract").setAction(async (taskArgs) => {
    ...
    const data = await myNFTOffchainGeneratorContract.getTokenCounter()
    console.log("Upload Image Count: ", Number(data))
})
